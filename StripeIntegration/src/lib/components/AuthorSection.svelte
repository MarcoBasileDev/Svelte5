<script lang="ts">
	import authorPic from '$assets/my_avatar.svg';
</script>

<section class="author-section px-32">
	<h2 class="mb-6">About the author</h2>
	<div class="author-container">
		<div class="author-text text-justify">
			<p class="mb-xs">
		...
		<img src={authorPic} alt="Author avatar">
	</div>
</section>
